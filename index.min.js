    ...
    link.rel = 'stylesheet';
    link.href = 'https://cdn.jsdelivr.net/gh/ahm23/CULearn@1.1.6a/index.min.css';
...
<main>
    <section class="lft">
        <div id='courses' class="section-wrapper courses-list">
...
`);
        ...
        function render(renderData) {
            for ([key, value] of Object.entries(courses)) {
                ...
                $('#course-list').append(`
                    <li class="list-element course"><a class="courseBlock" href="https://culearn.carleton.ca/moodle/course/view.php?id=` + value.code + `"><div>` + key + ` ` + value.section + `</div></a><div class="course_actions">` + (labURL ? labURL : '') + `</div></li></a>
                `);
            }
        }
        let courses = {};
