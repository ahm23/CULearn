...
let revert = false;
$('body').removeAttr('id').removeClass('drawer-open-left');
$('#page-wrapper').hide();
var head = document.getElementsByTagName('HEAD')[0];
var link = document.createElement('link');
link.rel = 'stylesheet';
link.type = 'text/css';
link.href = 'https://cdn.jsdelivr.net/gh/ahm23/CULearn@1.1.3a/index.min.css';
head.appendChild(link);
$('body').append(`
    <div style="text-align: center;" id="page-load">
...
$(document).ready(function() {
    $('body').attrchange({
        ...
        callback: function(event) {
            if (!revert && $('body').hasClass('drawer-open-left'))
                $('body').removeClass('drawer-open-left');
            if (!revert && $('body').attr('id'))
                $('body').removeAttr('id');
        }
    });
});
...
`);
    ...
    $(document).on('click', '#revert', function() {
        revert = true;
        $('main, header').hide();
        $('body').attr('id', 'page-my-index');
        $('body').addClass('format-site path-my chrome dir-ltr lang-en yui-skin-sam yui3-skin-sam culearn-carleton-ca--moodle pagelayout-mydashboard course-1 context-3196955 editing drawer-open-left jsenabled has-region-content used-region-content has-region-side-pre used-region-side-pre');
        $('#page-wrapper').show();
    });
});