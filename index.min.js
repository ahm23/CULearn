    ...
    link.rel = 'stylesheet';
    link.href = 'https://cdn.jsdelivr.net/gh/ahm23/CULearn@1.2.2a/index.min.css';
...
`);
        ...
        function render(renderData) {
            for ([key, value] of Object.entries(courses)) {
        ...
        for (group of $('.courses').toArray()) {
            let group_name = $(group).siblings('.category_label').text();
            $('#course-list').append(`
            <li class="list-element group"><div>` + group_name + `</div><svg class="arrow" viewBox="0 0 6 5" xmlns="http://www.w3.org/2000/svg"><path d="M3 5l3-5H0z" fill="#FFF" fill-rule="evenodd"></path></svg></li>
        `);
