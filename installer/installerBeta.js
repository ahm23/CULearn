$('body').attr('style', 'display: grid; margin: 0 !important;');
    $('#page-wrapper').hide();
    ...
    link2.href = 'https://fonts.googleapis.com/css2?family=Nunito&display=swap';
    document.getElementsByTagName('HEAD')[0].appendChild(link2);
    var link3 = document.createElement('link');
    link3.rel = 'stylesheet';
    link3.href = 'https://fonts.googleapis.com/css2?family=Montserrat&display=swap';
